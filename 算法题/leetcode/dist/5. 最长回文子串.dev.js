...
var expandAroundCenter = function expandAroundCenter(s, left, right) {
...
var longestPalindrome = function longestPalindrome(s) {
  ...
  for (var i = 0; i < s.length; i++) {
    ...
    var len2 = expandAroundCenter(s, i, i + 1); //取最大长度

    var len = Math.max(len1, len2); //根据最大长度取得起始坐标和结束坐标
...
longestPalindrome('cbbd'); //Manacher 算法
// /imgs/5.
